	...
	public ViewCart() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				setVisible(false);
				FlowerBrowserUser FBU= new FlowerBrowserUser();
				FBU.setVisible(true);
			}
		});
		...
		JButton btnNewButton_1 = new JButton("Procced to payment");
		...
		list.setModel(new AbstractListModel() {
			String[] values = new String[] {
					"Rose                      2021-1-12                        5                                  $12.50",
					"Tulip                      2023-1-1                         6                                   $9.00", 
					"Lily                         2020-10-1                       7                                   $21.00",
					"Sunflower                2022-2-11                       10                                 $18.00"
					};
			public int getSize() {
		...
		JLabel lblNewLabel = new JLabel("Name                     Date                             Quantity                                    Price");
