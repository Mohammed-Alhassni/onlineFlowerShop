...
public class ProductsMenuManagement extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ProductsMenuManagement frame = new ProductsMenuManagement();
	 ...
	 * Create the frame.
	 */
	public ProductsMenuManagement() {
		setTitle("Products Menu Management");
		...
		btnNewButton.setBounds(44, 397, 158, 29);
		contentPane.add(btnNewButton);
		
		JButton btnNewButton_1 = new JButton("Add new Products");
		...
		btnNewButton_1.setBounds(370, 397, 158, 29);
		...
		btnNewButton_2.setBounds(214, 397, 158, 29);
